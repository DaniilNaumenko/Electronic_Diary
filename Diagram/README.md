...
5. Приложение проверяет вводимые данные на полность и правильность. 
...
4. Приложение перезаписывает основную базу данных в резервную копию;
5. Приложение проверят введённый уникальнйы номер на присутствие его в базе данных.
...
2. Приложение отображает окно редактирования, в котором предлагает пользователю выбрать один из вариантов поиска записи и выбрать один из вариантов редактивания: редактировать имя, редактировать фамилию, редактировать отчество,  редактировать адрес, редактировать класс,  редактировать отметки,  редактировать дату рождения.
...
6. Приложение производит поиск записи в которой нужно изменить параметр.
